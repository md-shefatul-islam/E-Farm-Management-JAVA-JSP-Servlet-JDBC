                        ...
                        <div class="col text-justify">
                            <div class="card shadow mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="placeordercrop" method="post">
                                        <div class="form-row">
                                            <div class="col">
                                        ...
                                        <div class="form-row">
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="buname" type="text" placeholder="Enter buyer name" name="buname" value="${crop.funame}" readonly>
                                                </div>
                                            </div>
                                        </div>
...
<%--                                                        <strong>Date</strong>--%>
<%--                                                    </label>--%>
<%--                                                    <input class="form-control" id="date" type="datetime-local" placeholder="Enter date" name="date" >--%>
<%--                                                </div>--%>
<%--                                            </div>--%>
<%--                                        </div>--%>
