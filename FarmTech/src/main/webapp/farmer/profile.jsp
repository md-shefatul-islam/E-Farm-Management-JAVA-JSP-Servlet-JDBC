...
<%--                                </div>--%>
                                ...
                                <div class="card-body">
                                    <c:set var="pass" scope="request" value='<%= request.getAttribute("delete")%>'>
                                    </c:set>

                                    <c:if test="${fn:contains(pass, 'failed')}">
                                        <p>Delete <b>Failed...Try Again...</b></p>
                                    </c:if>
                                    ...
                                    <div class="form-row">
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="username" placeholder="Enter UserName" name="username" value="${farmer.uname}" readonly>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="password" placeholder="Enter Password" name="password" value="${farmer.password}" readonly></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="date" id="dob" placeholder="Enter Date of Birth" name="dob" value="${farmer.dob}" readonly></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="balance" placeholder="Enter balance" name="balance" value="${farmer.balance}" readonly></div>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <a href="<%=request.getContextPath()%>/editprofile">
                                            <button class="btn btn-primary btn-sm" type="submit">Edit Details</button>
                                        </a>
                                        <a href="<%=request.getContextPath()%>/changepassword" class="btn btn-primary btn-sm" type="button">
                                            Change Password
                                        </a>
                                        <a class="btn btn-primary btn-sm" type="button" href="<%=request.getContextPath()%>/deletemyaccount">
                                            Delete Account
                                        </a>
                                    </div>
                                </div>
