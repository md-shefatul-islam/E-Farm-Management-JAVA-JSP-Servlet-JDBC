                            ...
                            <div class="p-5" style="background-color: #d4f219; height: 480px">
                                ...
                                <form class="user" action="login" method="post">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control form-control-user" id="npass" type="text" aria-describedby="emailHelp" placeholder="Enter New Password..." name="npass">
                                    </div>

                                    <label for="rnpass">Re-Type New Password</label>
                                    <div class="form-group">
                                        <input class="form-control form-control-user" id="rnpass" type="password" placeholder="Enter New Password again" name="rnpass">
                                    </div>
